/*
  ...
  - You are about to alter the column `createdTimestamp` on the `Message` table. The data in that column could be lost. The data in that column will be cast from `DateTime` to `Int`.
